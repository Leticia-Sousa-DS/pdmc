...
class CartoonDao {
  static const String tableSql = 'CREATE TABLE $_tablename('
      '$_name TEXT, '
      '$_rating INTEGER, '
      '$_totalEpisodes INTEGER), ' // Nova coluna
      '$_image TEXT)';

  static const String _tablename = 'cartoonTable';
  static const String _name = 'nome';
  static const String _rating = 'nota';
  static const String _totalEpisodes = 'totalEpisodes'; // Nova variável
  ...
  Map<String, dynamic> toMap(Cartoon desenho) {
    ...
    mapaDeDesenhos[_totalEpisodes] = desenho.totalEpisodios;
  ...
  List<Cartoon> toList(List<Map<String, dynamic>> mapaDeDesenhos) {
    ...
    for (Map<String, dynamic> linha in mapaDeDesenhos) {
      final Cartoon desenho =
          Cartoon(linha[_name], linha[_image], linha[_rating], linha[_totalEpisodes]);
