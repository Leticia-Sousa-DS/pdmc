...
class Cartoon extends StatefulWidget {
  ...
  Cartoon(this.nome, this.foto, this.nota, this.totalEpisodios, {Key? key})
      : super(key: key);
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //tentativa de criar o botão de exclusão
                    Align(
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content:
                                      Text('Deseja excluir ${widget.nome}?'),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: LinearProgressIndicator(
                        color: Colors.white,
                        value: widget.episodio / widget.totalEpisodios,
